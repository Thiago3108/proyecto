...
def abrir_2():
    ...
    t_resultados.insert("end", "HEMORRAGIAS\nPodemos definir hemorragia como la salida de sangre de los vasos sanguíneos comoconsecuencia de la rotura de los mismos.\nActuación:\n·Lavarse las manos.\n·Colocarse los guantes.\n·Detener la hemorragia: Sies abundante pedir ayuda al 112:\n1ª Opción: COMPRESIÓN DIRECTA DEL PUNTO SANGRANTE.\n·Comprimir directamente la zona quesangra, con gasas o pañuelos limpios.\n·Mantener la compresión entre 5 y 10 minutos, sin retirar nunca el apósito.\n·Si siguesangrando, añadir más gasas.\n·Mantener siempre el miembro elevado.\n·Sujetar las gasas con vendaje compresivo.\n2ª Opción:COMPRESIÓN DE LA ARTERIA SOBRE EL HUESO SUBYACENTE.\n·Si a pesar de lo anterior, persiste la hemorragia, realizar compresióndirecta sobre la arteria correspondiente a la zona del sangrado y siempre por encima de la misma, con:\n·a) Si la hemorragia esen el brazo: Compresión con la yema de los dedos sobre la arteria humeral.\n·b) Si la hemorragia es en la pierna: Compresióncon el talón de la mano sobre la arteria femoral.\nQué no hacer:\n·Quitar gasas empapadas.\n·Se deben evitar los torniquetes,pues al evitar completamente el paso de sangre se dañan también zonas sanas.\nHemorragia interna. Síntomas delshock:\n·Consciente ó no.\n·Palidez.\n·Sudoración fría.\n·Extremidades frías.\n·Labios azulados.\n·Pulso débil y acelerado\n·Respiración superficial y acelerada.\nAvisar al 112 y tumbar con la cabeza más baja que las piernas (posición detrendelenburg: con las piernas más altas que el resto del cuerpo).\nHemorragia nasal o epistaxis:\n·Comprimir ligeramente laaleta nasal del lado sangrante hacia el tabique nasal durante 10 minutos, si no cesa continuar otros 10 minutos.\n·Si continúa,coloque una gasa o algodón empapado en agua oxigenada en la fosa nasal que sangra introduciéndola poco a poco.\n·Aplique fríolocal en el lado sangrante.\n·Si la hemorragia dura mas de 30 minutos acudir al centro médico más cercano.")
